    ...
    return (
        ...
        <table className='table'>
            ...
            <tr
             style={{
                backgroundColor: (() => {
                  const subtotalPre = tinot.reduce((a, b) => a + b.SubtotalPre, 0);
                  const subtotalReal = tinot.reduce((a, b) => a + b.SubtotalReal, 0);
            ...
            ><td style={{textAlign: 'center'}}>Tintas S/.</td> <td> </td><td> </td><td> </td><td> </td>
            <td style={{textAlign: 'center'}}>
                {tinot.reduce((a,b) => a+b.SubtotalPre,0).toFixed(2)}
                </td>
                <td> </td><td> </td>
                <td style={{textAlign: 'center'}}>
                {tinot.reduce((a,b) => a+b.SubtotalReal,0).toFixed(2)}   
                </td>
                </tr>
           </tfoot>
        </table>
